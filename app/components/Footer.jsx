      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/" className="text-gray-400 hover:text-white transition-colors">Internal Tools</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <form onSubmit={handleSubmit} className="flex">
              <input
                ...
                className="flex-1 px-4 py-2 bg-gray-900 border border-gray-800 rounded-l-lg focus:outline-none focus:border-blue-500 text-white text-sm"
                value={email}
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="px-4 py-2 bg-blue-500 rounded-r-lg text-white text-sm font-semibold hover:bg-blue-600 transition-colors"
                suppressHydrationWarning
              >
                Subscribe
              </motion.button>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              &copy; 2025 NexaDev. All rights reserved.
            </p>
